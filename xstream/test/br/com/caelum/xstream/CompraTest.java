...
public class CompraTest {
	...
	@Test
	public void DeveGerarCadaUmDosProdutosDeUmCompra() {
	...
	@Test
	public void DeveGerarUmaCadaUmDosProdutosDeUmCompraDoXml() {
	...
	public void deveUtilizarUmConversorTotalmenteCustomizado() {
		...
		String xmlEsperado = "<compra estilo=\"novo\">\n" 
	           + "  <id>15</id>\n"
	           + "  <fornecedor>johnathan.ciqueira@gmail.com</fornecedor>\n"
	           + "  <endereco>\n"
	           + "    <linha1>Rua Quintana, 753</linha1>\n"
	           + "    <linha2>4 andar - Sao Paulo - SP</linha2>\n"
	           + "  </endereco>\n" 
	           + "  <produtos>\n" 
	           + "    <produto codigo=\"1587\">\n" 
	           + "      <nome>geladeira</nome>\n"
